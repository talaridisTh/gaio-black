/******/ (() => { // webpackBootstrap
/*!***************************************************!*\
  !*** ./resources/js/dashboard/plugins/checked.js ***!
  \***************************************************/
...
function checked() {
  return {
    ...
    selectAllCheckboxes: function selectAllCheckboxes() {
      ...
      _toConsumableArray(checkboxes).map(function (el) {
        el.checked = _this.selectall;
      });
    },
    checkedMainInput: function checkedMainInput() {
      var checkedAll = [],
          checkboxes = document.querySelectorAll('[id^=checkbox]');
